...
#Script: run_cc_lunar.sh                                                     
#  Purpose: Standard PEBBLE training with oracle/synthetic labels              
#  When to use: sbatch run_cc_lunar.sh — baseline run, no human involvement 
